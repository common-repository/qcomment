...
<div ng-controller="Project" ng-cloak>
    ...
    <div ng-show="noAPIKey">
        Пожалуйста, введите ключ API на
        <?php
//        _e( 'Set QComment API key, please', 'qcomment' );
        echo ' <a href="' . admin_url( 'admin.php?page=qcomment' ) . '"> странице настроек.</a>';
        ?>
    </div>
...
<!--        <p>Загрузка данных ...</p>-->
    ...
    <div ng-show="error_code == 401 || status == 'no'">
        ...
        <div ng-show="createProjectFormVisible" class="qcomment-form" id="qcomment_form">
            ...
            <div id="qcomment_main_settings" class="settings_tab" qc-tab>
                <table>
                    ...
                    <tr>
                        ...
                        <th>Тематика <?php var_dump($subject)?></th>
                        <td>
                    ...
                    <tr>
                        ...
                        <th>Тариф</th>
                        <td>
                            <select id="qcomment_tariff_id" ng-model="tariff_id">
                                <?php $price = ''; foreach ($tariff as $value) { ?>
                                    <option value="<?php echo $value['id']; ?>"  <?php echo selected( $tariff_id, $value['id'] );?> data-selectPrice="<?=$value['price'];?>"><?php echo $value['name']
                                            . ' (' . $value['symbols'] . ') ' . $value['price']; ?></option>
	                                <?php  $price = ($tariff_id == $value['id']) ? substr($value['price'], 0, -4) : $price; ?>
                                <?php } ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <th>Цена</th>
                        <td>
	                        <input type="text" ng-model="price" class="regular-text" value="<?php echo $price ?>">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e( 'View in', 'qcomment' ) ?>
                                <a href="https://qcomment.ru/user/teams" target="_blank">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php foreach ($qcomment_data['comment_configs'] as $id => $value) { ?>
                                <?php
                                $checked = '';
                                $comment_configs = empty($comment_configs)? array():$comment_configs;
            ...
            <div id="qcomment_restrictions_settings" class="settings_tab hidden" qc-tab>
                <table>
                    <tr>
                        <th>Количество дней для лимита</th>
                        <td><input type="text" ng-model="cnt_day_limit" class="regular-text"></td>
                    </tr>
                    <tr>
                        <th>Максимальное количество работ за к-во дней</th>
                        <td><input type="text" ng-model="limit" class="regular-text"></td>
                    </tr>
                    <tr>
                        <th>Случайное число в к-во дней</th>
                        <td>
                    ...
                    <tr>
                        <th>Задержка между работами (в мин.)</th>
                        <td>
                            <input type="text" ng-model="delay_from"> -
                            <input type="text" ng-model="delay_to">
                        </td>
                    </tr>
                    <tr>
            ...
            <div style="float: right"> Баланс RUB: <?=$balance['rub']?></div>
            </div>
            <div class="clear"></div>
