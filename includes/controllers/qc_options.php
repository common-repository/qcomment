...
class QC_Options extends SC_Controller {
    ...
    public function admin_init() {
		...
		$data = $qcep->balance_account('RUB',$_REQUEST['qc_app_key']);
        ...
        register_setting( 'qcomment', 'qc_app_key', array( $this, 'check_by_for_all' ) );
        ...
        register_setting( 'qcomment', 'qc_cnt_day_limit' );
        register_setting( 'qcomment', 'qc_min_day_limit' );
        register_setting( 'qcomment', 'qc_max_day_limit' );
        register_setting( 'qcomment', 'qc_delay_from' );
        register_setting( 'qcomment', 'qc_delay_to' );
    ...
    public function check_by_for_all( $value ) {
        ...
        if ( $value !== null ) {
            ...
            if ( empty( $_POST[ 'qc_app_key' ] ) ) {
                $fields_errors[] = 'Api ключ указан неверно.';
            }
