...
class QC_Ajax {
    ...
    public function save_project() {
	    ...
	    update_option( 'qc_subject', $_POST['subjects'] );
    ...
    public function buy_comments() {
        ...
        if ( isset( $_POST[ 'comments_count' ] ) && isset( $_POST[ 'project_id' ] ) ) {
            ...
            $response = wp_remote_post( 'https://qcomment.ru/api/payproject', array(
                    'method' => 'POST',
                    'timeout' => 45,
                    'redirection' => 5,
                    'httpversion' => '1.0',
    ...
    public function activate_project() {
        if (isset($_POST['project_id'])) {
            ...
            //запрос на оплату проекта
            $response = wp_remote_post( 'https://qcomment.ru/api/projectstatus', array(
                    'method' => 'POST',
                    'timeout' => 45,
                    'redirection' => 5,
                    'httpversion' => '1.0',
    ...
    public function decline_comment() {
        if ( isset( $_POST[ 'comment_id' ] ) && 0 < (int)$_POST[ 'comment_id' ] ) {
            ...
            $response = wp_remote_post( 'https://qcomment.ru/api/revision', array(
                    'method' => 'POST',
                    'timeout' => 45,
                    'redirection' => 5,
                    'httpversion' => '1.0',
